...
<ul>
  <li>install all the libraries specified whithin requirement.txt on  your virtual env</li>
...
Project Link: [https://github.com/ay-ka/Evolutionary-Algorithms](https://github.com/ay-ka/Evolutionary-Algorithms)
